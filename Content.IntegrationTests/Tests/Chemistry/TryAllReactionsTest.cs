...
#pragma warning disable NUnit2045
                            Assert.That(_solutionContainerSystem.TryAddReagent(
                                solutionEnt.Value,
                                id,
                                reactant.Amount,
                                out var quantity,
...
#pragma warning restore NUnit2045
                        ...
                        var possibleReactions = SProtoMan
                        ...
                        _solutionContainerSystem.SetTemperature(
                            solutionEnt.Value,
                            reactionPrototype.MinimumTemperature);
                        ...
                        if (reactionPrototype.MixingCategories != null)
                        {
                            ...
                            _solutionContainerSystem.UpdateChemicals(
                                solutionEnt.Value,
                                true,
                                mixerComponent);
                        }
