...
public sealed partial class JobEntry : BoxContainer
{
    ...
    public JobEntry(CargoBountyPrototype job, IEntityManager entMan, IPrototypeManager protoMan)
    {
        ...
        foreach (var entry in job.Condition.GetManifestEntry(entMan, protoMan))
        {
            items.Add(entry);
        }
